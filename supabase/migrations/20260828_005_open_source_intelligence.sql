...
CREATE INDEX IF NOT EXISTS security_identity_cik_idx ON security_identities(cik);
CREATE INDEX IF NOT EXISTS security_identity_ticker_idx ON security_identities(ticker);
...
CREATE INDEX IF NOT EXISTS insider_security_date_idx ON insider_transactions(security_id, transaction_date);
...
CREATE INDEX IF NOT EXISTS institutional_security_date_idx ON institutional_holdings(security_id, report_date);
...
CREATE INDEX IF NOT EXISTS financing_security_time_idx ON financing_events(security_id, announced_at);
...
CREATE INDEX IF NOT EXISTS macro_series_vintage_idx ON macro_observations(series_id, vintage_date, observation_date);
