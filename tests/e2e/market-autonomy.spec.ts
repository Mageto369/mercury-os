...
test("market autonomy endpoints fail closed without persistent data", async ({
  request,
}) => {
...
test("manual market workers stay shadow-only when data infrastructure is absent", async ({
  request,
}) => {
